...
export const TokenBorrowLimitations = {
    ...
    ProtocolShare: decimalToBig('0.30'),
    InitialBorrowRate: decimalToBig('0.30'),
    OPTIMAL_UTILIZATION_RATE: decimalToBig('0.30'),
    StableRateSlope1: decimalToBig('0.02'),
    StableRateSlope2: decimalToBig('0.01'),
    VariableRateSlope1: decimalToBig('0.00'),
    VariableRateSlope2: decimalToBig('0.01'),
    baseRate: decimalToBig('0.04'),
    AllowStableJob: true,
}
