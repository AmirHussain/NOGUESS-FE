...
const bigToDecimalUnits = (num, units) => (num ? ethers.utils.formatEther(num, units) : '0');
...
export { bigToDecimal, decimalToBig, bigToDecimalUnits, decimalToBigUnits, bigToDecimalObject, decimalToBigObject };
